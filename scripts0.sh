...
python train_powersgd.py --epochs 50 --lr 0.0002 --batch_size 320 --setting "ddp" --world_size 2
python train_quantization.py --epochs 50 --lr 0.0002 --batch_size 320 --setting "ddp" --world_size 2
# python train_fsdp.py --epochs 50 --lr 0.0002 --batch_size 160 --setting "fsdp" --world_size 2
