...
def ddp_train(rank, world_size, args):
    ...
    if rank == 0:
        wandb.init(project="VIT_Distributed", name="ViT_DDP", config=wandb_config)
...
if __name__ == "__main__":
    ...
    os.environ['WANDB_API_KEY'] = 'fa0767adc156a87ed43a394680774f3116fc3ed2'
    ...
    if args.setting == "baseline":
        ...
        #Train the model
        with wandb.init(project="VIT_Distributed", name="Baseline", config=wandb_config):
